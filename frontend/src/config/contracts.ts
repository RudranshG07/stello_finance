...
export const CONTRACTS = {
  ...
  /** Native XLM wrapped as a Soroban token (SAC) — testnet */
  nativeXlmSac: import.meta.env.VITE_NATIVE_XLM_SAC || 'CDLZFC3SYJYDZT7K67VZ75HPJVIEUVNIXF47ZG2FB2RMQQVU2HHGCYSC',
} as const;
