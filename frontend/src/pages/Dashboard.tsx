  ...
  return (
    ...
    >
      ...
      <div>
        ...
        >
          <h3 style={{ fontSize: 16, fontWeight: 600, color: W }}>{title}</h3>
          {tag && (
            <span
              style={{
                fontSize: 10,
        ...
        <p style={{ fontSize: 13, color: T2, lineHeight: 1.75 }}>{desc}</p>
      </div>
    </div>
  );
}
    ...
    >
      ...
      {stat && (
        <div style={{ marginBottom: 10 }}>
          <span style={{ fontSize: 20, fontWeight: 700, color: Y }}>
            {stat}
          </span>
          {statLabel && (
            <span style={{ fontSize: 12, color: T3, marginLeft: 5 }}>
              {statLabel}
            </span>
          )}
        </div>
...
export default function Dashboard() {
  ...
  const apr =
    apy.currentApy > 0 ? apy.currentApy : apy.apy30d > 0 ? apy.apy30d : 0;
  ...
  const wrap = (maxW = 1100): CSSProperties => ({
    maxWidth: maxW,
    margin: "0 auto",
    padding: "0 24px",
  });
    ...
    <div style={{ background: "transparent", color: W, minHeight: "100vh" }}>
        ...
        <div style={wrap()}>
          <div className="lido-hero-grid">
            ...
            <div>
              ...
              >
                Stake XLM, receive{" "}
                <strong style={{ color: W, fontWeight: 600 }}>sXLM</strong> — a
                yield-bearing token that appreciates automatically. Stay liquid
                while earning Stellar staking rewards.
              </p>
          ...
          <div className="lido-stat-strip">
            {[
              ...
              },
              {
                ...
                val: aprDisplay,
                sub:
                  apy.apy30d > 0 ? `30d: ${apy.apy30d.toFixed(2)}%` : undefined,
              },
          ...
          <div style={wrap()}>
            ...
            >
              <div>
                ...
                <h3 style={{ ...sh, marginBottom: 0, fontSize: 18 }}>
              ...
              <button
                ...
                onMouseEnter={(e) =>
                  !isExporting && (e.currentTarget.style.background = YD)
                }
          ...
          <div className="lido-two-col">
            ...
            <div className="lido-reveal">
              ...
              >
                ...
                <strong style={{ color: W }}>sXLM</strong> — a yield-bearing
                token that automatically appreciates as validator rewards
                accrue.
              </p>
              <p style={{ fontSize: 14, color: T2, lineHeight: 1.8 }}>
                No lockups. No manual reward claims. The exchange rate rises
                every epoch — your sXLM is worth more XLM over time.
              </p>
            </div>
            ...
            >
              ...
              <div style={{ fontFamily: "monospace", fontSize: 12 }}>
                ...
                >
                  <span style={{ color: T3 }}>T_xlm</span>{" "}
                  <span>Total XLM staked</span>
                  <span style={{ color: T3 }}>T_sxlm</span>{" "}
                  <span>Total sXLM supply</span>
                </div>
                <div
                  style={{
                    borderTop: `1px solid ${BR}`,
                ...
                >
                  ...
                  <p style={{ color: T3, fontSize: 11 }}>
                    Rewards ↑ T_xlm · Supply fixed → ER rises
                  </p>
                </div>
                <div
                  style={{
                    borderTop: `1px solid ${BR}`,
                    paddingTop: 18,
                    marginBottom: er > 1 ? 18 : 0,
                  }}
                >
                  <p style={{ color: T2, marginBottom: 4 }}>
                    APY = (ER₁/ER₀)^(1/Δt) − 1
                  </p>
                  <p style={{ color: T3, fontSize: 11 }}>
                    Compound growth, epoch-based
                  </p>
                </div>
                {er > 1 && (
                  <div style={{ borderTop: `1px solid ${BR}`, paddingTop: 18 }}>
                    <p style={{ color: T3, fontSize: 11, marginBottom: 6 }}>
                      Live exchange rate
                    </p>
                    <p style={{ fontSize: 22, fontWeight: 700, color: Y }}>
                      {er.toFixed(7)}
                    </p>
                  </div>
                )}
          ...
          <div style={{ borderTop: `1px solid ${BR}` }}>
            {(
              [
                {
                  n: "01",
                  title: "Liquid Staking MVP",
                  desc: "Deposit XLM → mint sXLM. The exchange rate automatically rises as validator rewards accrue. No manual claiming. sXLM = XLM / ER on mint, XLM = sXLM × ER on burn.",
                  tag: "M1",
                },
                {
                  n: "02",
                  title: "Exchange Rate Engine",
                  desc: "APR/APY derived purely from on-chain exchange rate history. No hardcoded yields — what you see is what the protocol actually earns from lending interest.",
                  tag: "M2",
                },
                {
                  n: "03",
                  title: "Withdrawal Queue",
                  desc: "Instant redemption via the liquidity buffer (D × α safety factor). Delayed queue with ~24h cooldown. Slashing-aware accounting throughout the entire withdrawal flow.",
                  tag: "M3",
                },
                {
                  n: "04",
                  title: "Risk Engine",
                  desc: "Slashing impact model: T_xlm,new = T_xlm,old × (1 − s). Emergency pause logic for protocol safety. Withdrawal queue recalculation after slashing events.",
                  tag: "M4",
                },
                {
                  n: "05",
                  title: "Capital Efficiency",
                  desc: "Use sXLM as collateral in the lending protocol. AMM liquidity pool (sXLM/XLM). Leverage loop up to 3.33× with Net Yield = (L×r) − ((L−1)×b). Governance DAO.",
                  tag: "M5",
                },
              ] as const
            ).map((f, i, arr) => (
          ...
          >
            <div className="lido-four-cards" style={{ background: BR }}>
              <ProductCard
                ...
                stat="70%"
                statLabel="max LTV"
                desc="Deposit sXLM as collateral. Borrow XLM at 70% LTV. Health factor monitored on-chain."
                delay={0}
              />
              <ProductCard
                icon="💧"
                ...
                stat="0.3%"
                statLabel="swap fee"
                desc="Provide sXLM/XLM liquidity to the AMM pool. Earn swap fees on top of staking yield."
                delay={60}
              />
              <ProductCard
                icon="⚡"
                ...
                stat="3.33×"
                statLabel="max"
                desc="Stake → collateral → borrow → restake. Up to 3.33× with live net yield calculator."
                delay={120}
              />
              <ProductCard
                icon="🗳"
                title="Governance"
                href="/governance"
                desc="Vote on protocol parameters using sXLM balance. Create and execute on-chain proposals."
                delay={180}
              />
            </div>
          </div>
            ...
            >
              {[
                ...
                >
                  ...
                  <p style={{ fontSize: 16, fontWeight: 600, color: W }}>
                    {item.val}
                  </p>
                </div>
              ))}
            ...
            >
              {(
                [
                  {
                    label: "Total XLM Staked",
                    val: isLoading ? "—" : `${fmt(tvlXlm)} XLM`,
                    sub: stats.tvlUsd > 0 ? `$${fmt(stats.tvlUsd)}` : undefined,
                  },
                  {
                    label: "Current APR",
                    val: isLoading ? "—" : apr > 0 ? `${apr.toFixed(2)}%` : "—",
                    sub:
                      apy.apy30d > 0
                        ? `30d: ${apy.apy30d.toFixed(2)}%`
                        : undefined,
                  },
                  {
                    label: "Exchange Rate",
                    val: isLoading ? "—" : er.toFixed(4),
                    sub: "1 sXLM = ER × XLM",
                  },
                  {
                    label: "Protocol Fee",
                    val: `${stats.protocolFeePct}%`,
                    sub: "on rewards",
                  },
                  {
                    label: "Stakers",
                  ...
                  { label: "Withdrawal", val: "~24h", sub: "delayed queue" },
                  {
                    ...
                    val: isLoading
                      ? "—"
                      : `${fmt(stats.treasuryBalance / 1e7)} XLM`,
                    sub: "collected fees",
                  },
                ] as const
              ).map((s, i) => {
      ...
      >
        <div style={{ ...wrap(600), textAlign: "center" }}>
          ...
          >
            Join the Native XLM Liquid Restaking Protocol.
            <br />
          ...
          >
            <div>
              ...
              >
                ...
                <span style={{ fontWeight: 700, fontSize: 14, color: W }}>
                  sXLM Protocol
                </span>
              </div>
              <p style={{ fontSize: 12, color: T3, lineHeight: 1.7 }}>
                Native XLM Liquid Restaking
                <br />
                on Stellar · Soroban Smart Contracts
              </p>
            </div>
            {[
              {
